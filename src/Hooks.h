...
namespace DDR
{
	...
	typedef int64_t(WINAPI* GenTopicType)(RE::TESTopic* a_1, int64_t a_2, int64_t a_3, RE::TESTopicInfo* a_4, RE::TESTopic* a_5, int64_t a_6);
	...
	private:
		...
		static int64_t GenTopic(RE::TESTopic* a_1, int64_t a_2, int64_t a_3, RE::TESTopicInfo* a_4, RE::TESTopic* a_5, int64_t a_6);
		static inline GenTopicType _GenTopic;
